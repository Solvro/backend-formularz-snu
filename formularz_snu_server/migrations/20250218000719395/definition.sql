...
--
-- Class FormEntry as table form_entries
--
...
--
-- Class GlobalConfig as table global_config
--
...
--
-- Class Participant as table participants
--
...
--
-- Foreign relations for "form_entries" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('formularz_snu', '20250218000719395', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250218000719395', "timestamp" = now();
